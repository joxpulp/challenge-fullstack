...
`;var xt="/assets/cart.7e54eda4.svg";const yt=()=>{const t=f(),{userData:r}=p(o=>o.auth),a=()=>{t(z()),t(xe(!1)),t(ke())},n=()=>{t(xe(!1))};return e.createElement(u,{position:"absolute",width:"120px",alignItems:"center",right:["10px","10px","110px"],top:"5",justifyContent:"center",bg:"#1d1d1dfd",color:"#e4e4e4",height:"160px",zIndex:100,onBlur:n},e.createElement(Pe,{display:"flex",flexDirection:"column",alignItems:"center"},e.createElement(F,{to:"/profile",onClick:n},e.createElement(O,{mb:"20px"},"Edit User")),e.createElement(F,{to:"/purchases",onClick:n},e.createElement(O,{mb:"20px"},"Purchases")),r.isAdmin&&e.createElement(F,{to:"/adminpanel",onClick:n},e.createElement(O,{mb:"20px"},"Admin Panel")),e.createElement(O,{onClick:a},"Logout")))};function ft(){const{colors:{primary:t}}=y.exports.useContext(Ye),r=f(),{userData:a,loggedIn:n}=p(b=>b.auth),{cartData:o,totalItems:c}=p(b=>b.cart),{userMenu:s}=p(b=>b.ui);y.exports.useEffect(()=>{localStorage.setItem("userData",JSON.stringify(a))},[a]),y.exports.useEffect(()=>{localStorage.setItem("cartData",JSON.stringify(o))},[o]);const m=()=>{r(xe(!1))};return e.createElement(u,{position:"relative",as:"header",height:"60px",alignItems:"center",px:["20px","20px","145px"],bg:t,color:"white",borderBottom:"1px solid white"},e.createElement(F,{to:"/",onClick:m},e.createElement(h,{mr:"20px",cursor:"pointer"},"Heki")),e.createElement(u,{as:"nav",flex:1},e.createElement(Pe,{flex:1,justifyContent:"space-evenly"},e.createElement(F,{to:"/",onClick:m},e.createElement(O,null,"Shop")),e.createElement(F,{to:"/about",onClick:m},e.createElement(O,null,"About")),e.createElement(F,{to:"/contact",onClick:m},e.createElement(O,null,"Contact"))),e.createElement(Pe,{justifyContent:"space-evenly"},e.createElement(F,{to:"/cart"},e.createElement(u,{alignItems:"center",mr:"20px",onClick:m},e.createElement(C,{mr:"5px",src:xt}),e.createElement(d,null,n&&o.length!==0&&c))),e.createElement(u,{height:"100%",alignItems:"center"},e.createElement(u,{onClick:()=>r(xe(!s))},e.createElement(C,{borderRadius:"100%",width:"20px",mr:"10px",src:a.avatar,alt:"avatar"}),e.createElement(O,null,a.name)))),s&&e.createElement(yt,null)))}const U=I(D.main)`
	${k}
	${A}
	${j}
	${P}
...
`;function $(a){var n=a,{label:t}=n,r=q(n,["label"]);const[o,c]=ue(r);return e.createElement(u,{m:"20px",flexDirection:"column",width:"100%",alignItems:"center"},e.createElement(Le,i(i({width:["60%","60%","30%"]},o),r)),c.touched&&c.error&&e.createElement(d,{mt:"3px",color:"red"},c.error))}function Bt(){const t=M(),r=f(),{loading:a,errorMsg:n}=p(c=>c.ui),o=()=>{t.push("/signup"),r(ge()),r(ke())};return e.createElement(U,{alignItems:"center",justifyContent:"center",width:"100%",my:"50px",flexDirection:"column",initial:{opacity:0,x:"-90%"},animate:{opacity:1,x:0},exit:{opacity:0,x:"-90%"}},e.createElement(w,{bg:"white",width:["90%","90%","50%"],height:"500px",alignItems:"center",boxShadow:"0px 0px 25px 10px #F6F4FD",p:"10px"},e.createElement(Z,{initialValues:{email:"",password:""},validationSchema:vt,onSubmit:({email:c,password:s})=>{r(ge()),r(Y({email:c,password:s}))}},e.createElement(ee,{style:{width:"100%",display:"flex",flexDirection:"column",alignItems:"center"}},e.createElement(h,{my:"10px"},"Welcome Back"),e.createElement(d,{color:"#A9ABBD"},"Login with your email:"),n&&e.createElement(d,{m:"20px",color:"#b62929"},n),e.createElement($,{disabled:a,id:"email",name:"email",type:"email",placeholder:"Email"}),e.createElement($,{disabled:a,id:"password",name:"password",type:"password",placeholder:"Password"}),e.createElement(W,null,"Login")))),e.createElement(d,{m:"30px",cursor:"pointer",onClick:o},"Or create an account"))}function qt(){const t=M(),r=f(),{loading:a,errorMsg:n}=p(o=>o.ui);return e.createElement(U,{overflow:"hidden",alignItems:"center",justifyContent:"center",flexDirection:"column",width:"100%",my:"50px",initial:{opacity:0,x:"80%"},animate:{opacity:1,x:0},exit:{opacity:0,x:"80%"}},e.createElement(w,{bg:"white",width:["90%","90%","50%"],height:"850px",alignItems:"center",boxShadow:"0px 0px 25px 10px #F6F4FD",p:"10px"},e.createElement(Z,{initialValues:{email:"",password:"",name:"",lastname:"",age:"",cardId:"",address:""},validationSchema:At,onSubmit:(o,{resetForm:c})=>{r(ge()),r(me(o)),c()}},e.createElement(ee,{style:{width:"100%",display:"flex",flexDirection:"column",alignItems:"center"}},e.createElement(h,{my:"10px"},"Signup"),e.createElement(d,{color:"#A9ABBD"},"Fill your info"),n&&e.createElement(d,{m:"20px",color:"#b62929"},n),e.createElement($,{id:"email",name:"email",type:"email",placeholder:"Email*",disabled:a}),e.createElement($,{id:"password",name:"password",type:"password",placeholder:"Password*",disabled:a}),e.createElement($,{id:"name",name:"name",type:"text",placeholder:"Name*"}),e.createElement($,{id:"lastname",name:"lastname",type:"text",placeholder:"Lastname*",disabled:a}),e.createElement($,{id:"age",name:"age",type:"number",placeholder:"Age*"}),e.createElement($,{id:"cardId",name:"cardId",type:"number",placeholder:"Card Id (DNI)*",disabled:a}),e.createElement($,{id:"address",name:"address",type:"text",placeholder:"Address*",disabled:a}),e.createElement(W,null,"Sign Up")))),e.createElement(d,{m:"30px",cursor:"pointer",onClick:()=>t.push("/login")},"Or go to login"))}const Oe=n=>{var o=n,{isAuth:t,component:r}=o,a=q(o,["isAuth","component"]);return e.createElement(T,i({},a),t?e.createElement(Ce,{to:"/"}):e.createElement(r,null))},H=n=>{var o=n,{isAuth:t,component:r}=o,a=q(o,["isAuth","component"]);return e.createElement(T,i({},a),t?e.createElement(r,null):e.createElement(Ce,{to:"/login"}))};function B(o){var c=o,{onCancel:t,currentValue:r,width:a}=c,n=q(c,["onCancel","currentValue","width"]);const[s,m]=ue(n),[b,K]=y.exports.useState(!1),{userData:ye}=p(fe=>fe.auth),{product:ie}=p(fe=>fe.products),le=()=>{K(!b),t()};return y.exports.useEffect(()=>{K(!1)},[ye,ie]),e.createElement(u,{flexDirection:"column",m:"5px"},e.createElement(u,{mb:"5px"},b?e.createElement(Le,i(i({width:a||"80%"},s),n)):e.createElement(u,{p:"10px",cursor:"pointer",onClick:le,alignItems:"center",justifyContent:"center",width:a||"230px",borderBottom:"1px solid #C2C5E1"},e.createElement(h,{color:"#9b9b9b"},r)),e.createElement(R,{ml:"10px",width:"30px",onClick:le,type:"button"},b?"Cancel":"Edit")),m.touched&&m.error&&e.createElement(d,{color:"red"},m.error))}var Nt="/assets/cancel.a4530b38.svg";function Ae({currentImage:t,file:r,label:a,onCancel:n}){const[o,c]=y.exports.useState(null),s=new FileReader;r&&s.readAsDataURL(r),s.onload=()=>{r&&c(s.result)};const m=()=>{c(null),n()};return e.createElement(u,{position:"relative"},r&&e.createElement(C,{position:"absolute",cursor:"pointer",m:"10px",right:"0",width:"30px",src:Nt,onClick:m,zIndex:"2"}),e.createElement("label",{htmlFor:a},e.createElement(C,{cursor:"pointer",width:"150px",m:"10px",src:o||t})))}function Ft(){const t=f(),{userData:r}=p(a=>a.auth);return p(a=>a.ui),e.createElement(U,{alignItems:"center",justifyContent:"center",width:"100%",my:"50px"},e.createElement(w,{bg:"white",width:["90%","90%","50%"],height:"850px",alignItems:"center",boxShadow:"0px 0px 25px 10px #F6F4FD",p:"10px",initial:{opacity:0,x:"-90%"},animate:{opacity:1,x:0},exit:{opacity:0,x:"-90%"}},e.createElement(Z,{initialValues:{name:"",lastname:"",age:"",cardId:"",password:"",address:"",avatar:null},validationSchema:jt,onSubmit:a=>{const n=new FormData;a.name!==""&&n.append("name",a.name),a.lastname!==""&&n.append("lastname",a.lastname),a.age!==""&&n.append("age",a.age),a.address!==""&&n.append("address",a.address),a.password!==""&&n.append("password",a.password),a.avatar&&n.append("avatar",a.avatar),t(te(n))}},({values:a,setFieldValue:n})=>e.createElement(ee,{style:{width:"100%",display:"flex",flexDirection:"column",alignItems:"center"}},e.createElement(h,{my:"10px"},"Your Profile"),e.createElement(d,{mb:"10px",color:"#A9ABBD"},"Change everything you want, just click on edit field"),e.createElement(d,{color:"#A9ABBD"},"Click on the image to upload a new avatar"),e.createElement(Ae,{currentImage:r.avatar,label:"avatar",file:a.avatar,onCancel:()=>n("avatar",null)}),e.createElement("input",{id:"avatar",type:"file",onChange:o=>n("avatar",o.target.files[0]),style:{display:"none"}}),e.createElement(B,{currentValue:r.name,id:"name",name:"name",type:"text",placeholder:"Name",onCancel:()=>n("name","")}),e.createElement(B,{currentValue:r.lastname,id:"lastname",name:"lastname",type:"text",placeholder:"Lastname",onCancel:()=>n("lastname","")}),e.createElement(B,{currentValue:"********",id:"password",name:"password",type:"password",placeholder:"Password",onCancel:()=>n("password","")}),e.createElement(B,{currentValue:r.age,id:"age",name:"age",type:"number",placeholder:"Age",onCancel:()=>n("age","")}),e.createElement(B,{currentValue:r.cardId,id:"cardId",name:"cardId",type:"text",placeholder:"Card Id (DNI)",onCancel:()=>n("cardId","")}),e.createElement(B,{currentValue:r.address,id:"address",name:"address",type:"text",placeholder:"Address",onCancel:()=>n("address","")}),e.createElement(W,null,"Save profile")))))}const Lt=({name:t,price:r,thumbnail:a,productId:n,quantity:o})=>{const c=f();return e.createElement(u,{py:"30px",overflow:"hidden",width:["100%","100%","80%"],borderBottom:"1px solid black"},e.createElement(C,{borderRadius:"5px",width:["30%","30%","25%"],src:a,alt:"productImg"}),e.createElement(u,{mx:"30px",flexDirection:"column"},e.createElement(h,null,t),e.createElement(d,{my:"15px"},"USD ",r),e.createElement(d,null,"Quantity: ",o)),e.createElement(u,{flex:1,justifyContent:"end",alignItems:"end"},e.createElement(d,{onClick:()=>c(pe(n)),cursor:"pointer"},"Remove")))};function Ot(){const{cartData:t,total:r}=p(s=>s.cart),{purchases:a}=p(s=>s.purchase),n=f(),o=M(),c=()=>{n(ne())};return y.exports.useEffect(()=>{n(L())},[n,a]),t.length===0?e.createElement(ve,null,"Your cart is empty :("):e.createElement(U,{alignItems:"center",width:"100%",my:["20px","20px","50px"],initial:{opacity:0},animate:{opacity:1},exit:{opacity:0}},e.createElement(w,{mx:["20px","20px","145px"],flexDirection:"column"},e.createElement(u,{initial:{opacity:0,y:-100},animate:{opacity:1,y:0},exit:{opacity:0,y:-100},flexDirection:"column",mb:"45px"},e.createElement(h,null,"Your Cart"),e.createElement(d,{my:"20px",cursor:"pointer",onClick:()=>o.push("/")},"Not ready to checkout? Continue shopping")),e.createElement(u,{flexDirection:["column","column","row"]},e.createElement(u,{initial:{opacity:0,x:-200},animate:{opacity:1,x:0},exit:{opacity:0,x:-100},flexDirection:"column"},t.map(s=>e.createElement(Lt,{key:s._id,name:s.name,price:s.price,thumbnail:s.thumbnail,productId:s._id,quantity:s.quantity}))),e.createElement(u,{initial:{opacity:0,x:200},animate:{opacity:1,x:0},exit:{opacity:0,x:100},flexDirection:"column",py:"30px"},e.createElement(h,{py:"20px",borderBottom:"1px solid black"},"Order Summary"),e.createElement(h,{my:"20px"},"Total: $",r),e.createElement(W,{onClick:c},"Purchase")))))}function Ut({name:t,price:r,thumbnail:a}){return e.createElement(u,{overflow:"hidden",flexDirection:"column",width:"100%"},e.createElement(C,{borderRadius:"5px",width:"100%",src:a,alt:"productImg"}),e.createElement(h,{my:"15px"},t),e.createElement(d,null,"USD ",r))}function Tt(){const t=f(),{purchases:r}=p(a=>a.purchase);return y.exports.useEffect(()=>{t(V()),t(L())},[t]),r.length===0?e.createElement(ve,null,"You dont have any purchases"):e.createElement(oe,null,e.createElement(ce,null,e.createElement(h,null,"Your Purchases"),e.createElement(d,null,"Your history of purchases in one place")),e.createElement(Se,null,r.map((a,n)=>e.createElement(Ut,{key:n,name:a.name,price:a.price,thumbnail:a.thumbnail}))))}function zt({thumbnail:t,id:r}){const a=M(),n=f(),o=()=>{a.push(`adminpanel/productedit/${r}`),n(Ne())};return e.createElement(u,{border:"1px solid #e7e7e7",borderRadius:"5px",overflow:"hidden",flexDirection:"column",width:"100%",alignItems:"center"},e.createElement(C,{width:"100%",src:t,alt:"productImg"}),e.createElement(u,{width:"100%",alignItems:"center",justifyContent:"center",my:"15px"},e.createElement(R,{width:"30%",onClick:o,mr:"10px"},"Edit"),e.createElement(R,{width:"30%",onClick:()=>n(De(r))},"Delete")))}function Gt(){const t=M(),{products:r}=p(n=>n.products),a=f();return y.exports.useEffect(()=>{a(he())},[a]),e.createElement(oe,null,e.createElement(ce,null,e.createElement(h,{mb:"20px"},"Admin Panel (Add, Edit and Delete Products)"),e.createElement(R,{onClick:()=>t.push("/adminpanel/add"),width:"150px"},"Add Product")),e.createElement(Se,null,r.map((n,o)=>e.createElement(zt,{key:o,id:n._id,name:n.name,price:n.price,thumbnail:n.thumbnail}))))}const Ue=I(D.textarea)`
	${k}
	${A}
	${N}
	${j}
