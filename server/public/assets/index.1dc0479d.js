...
`,s=D(S.p)`
	...
	transition: ${t=>t.transition};
	cursor: ${t=>t.cursor};
`,Ct=()=>{const t=y(),{userData:n}=p(o=>o.auth),a=()=>{t(U()),t(Q(!1)),t(Pe())},r=()=>{t(Q(!1))};return e.createElement(u,{position:"absolute",alignItems:"center",top:60,right:[0,0,"110px"],width:["100%","100%","120px"],height:"160px",justifyContent:"center",bg:"#272727",color:"#e4e4e4",initial:{opacity:0,x:"100%"},animate:{opacity:1,x:0},exit:{opacity:0,x:"100%"},transition:{ease:"easeInOut"}},e.createElement(ke,{display:"flex",flexDirection:"column",alignItems:"center"},e.createElement(F,{mb:"20px"},e.createElement(q,{to:"/profile",onClick:r},"Edit User")),e.createElement(F,{mb:"20px"},e.createElement(q,{to:"/purchases",onClick:r},"Purchases")),n.isAdmin&&e.createElement(F,{mb:"20px"},e.createElement(q,{to:"/adminpanel",onClick:r},"Admin Panel")),e.createElement(F,{onClick:a},"Logout")))};var wt="/assets/cart.7e54eda4.svg";function $t({isOpen:t,setIsOpen:n}){const a=y(),{userData:r,loggedIn:o}=p(I=>I.auth),{cartData:c,totalItems:d}=p(I=>I.cart),{userMenu:m}=p(I=>I.ui),E=()=>{a(Q(!1)),n(!1)},B=()=>{a(Q(!m)),n(!1)};return g.exports.useEffect(()=>{localStorage.setItem("userData",JSON.stringify(r))},[r]),g.exports.useEffect(()=>{localStorage.setItem("cartData",JSON.stringify(c))},[c]),e.createElement(u,{as:"nav",flex:1,justifyContent:["flex-end","flex-end","flex-start"]},e.createElement(ke,{width:"100%",position:["absolute","absolute","relative"],top:[60,60,0],left:[t?0:"-100%",t?0:"-100%",0],flexDirection:["column","column","row"],flex:1,justifyContent:"space-evenly",alignItems:"center",p:["20px","20px",0],bg:["#272727","#272727","transparent"],opacity:[t?1:0,t?1:0,1]},e.createElement(F,{mb:["20px","20px",0]},e.createElement(q,{to:"/",onClick:E},"Shop")),e.createElement(F,{mb:["20px","20px",0]},e.createElement(q,{to:"/about",onClick:E},"About")),e.createElement(F,null,e.createElement(q,{to:"/contact",onClick:E},"Contact"))),e.createElement(ke,{justifyContent:"space-evenly"},e.createElement(F,{alignItems:"center",mr:"20px",onClick:E},e.createElement(q,{to:"/cart"},e.createElement(C,{mr:"5px",src:wt}),o&&c&&e.createElement(s,null,d))),e.createElement(F,{height:"100%",alignItems:"center"},o?e.createElement(u,{onClick:B},e.createElement(C,{borderRadius:"100%",width:"20px",mr:"10px",src:r.avatar,alt:"avatar"}),e.createElement(s,null,r.name)):e.createElement(q,{to:"/login"},"Login"))),e.createElement(de,{exitBeforeEnter:!0},m&&e.createElement(Ct,null)))}function It(){const{colors:{primary:t}}=g.exports.useContext(We),[n,a]=g.exports.useState(!1),r=y(),o=()=>{a(!n),r(Q(!1))};return e.createElement(u,{as:"header",position:"fixed",width:"100%",height:"60px",alignItems:"center",px:["20px","20px","145px"],bg:t,color:"white",borderBottom:"1px solid white",zIndex:1},e.createElement(u,{onClick:o,display:["flex","flex","none"],mr:"10px"},n?e.createElement(He,{fontSize:"25px"}):e.createElement(Ke,{fontSize:"25px"})),e.createElement(q,{to:"/",onClick:()=>r(Q(!1))},e.createElement(h,{mr:"20px",cursor:"pointer"},"Heki")),e.createElement($t,{isOpen:n,setIsOpen:a}))}const O=D(S.main)`
	${P}
	${k}
	${M}
	${A}
	...
	backdrop-filter: ${t=>t.glass&&"blur(10px )"};
	-webkit-backdrop-filter: ${t=>t.glass&&"blur(10px)"};
`;function ie({children:t}){const{loading:n}=p(a=>a.ui);return e.createElement(O,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},flexDirection:"column",width:"100%"},n?e.createElement(u,{height:"80vh",alignItems:"center",justifyContent:"center"},e.createElement(we.CubeSpinner,{size:100,frontColor:"#aaaaaa"})):e.createElement(e.Fragment,null,t))}const w=D(S.section)`
	${P}
	${k}
	${M}
	${A}
	...
	backdrop-filter: ${t=>t.glass&&"blur(10px )"};
	-webkit-backdrop-filter: ${t=>t.glass&&"blur(10px)"};
`;function le({children:t}){return e.createElement(w,{bg:"black",color:"white",height:"216px",width:"100%"},e.createElement(u,{flexDirection:"column",justifyContent:"center",mx:["20px","20px","145px"]},t))}function Ae({children:t}){return e.createElement(w,{flexDirection:"column",display:"grid",gridTemplateColumns:["repeat(1, minmax(100px, 1fr))","repeat(2, minmax(100px, 1fr))","repeat(4, minmax(100px, 1fr))"],gridGap:"30px",py:"54px",px:["20px","20px","145px"]},t)}function Dt({name:t,price:n,thumbnail:a,id:r}){const o=R(),c=y(),d=()=>{o.push(`/product/${r}`),c(Le()),c(Ee())};return e.createElement(u,{onClick:d,overflow:"hidden",flexDirection:"column",width:"100%",cursor:"pointer",initial:{opacity:0},animate:{opacity:1}},e.createElement(C,{borderRadius:"5px",width:"100%",src:a,alt:"productImg"}),e.createElement(h,{my:"15px"},t),e.createElement(s,null,"USD ",n))}var St="/assets/emptycart.178cfab5.svg";function ve({children:t}){return e.createElement(u,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},width:"100%",height:"100vh",flexDirection:"column",alignItems:"center",justifyContent:"center"},e.createElement(C,{mb:"20px",width:["70%","70%","30%"],src:St}),e.createElement(s,null,t))}function Pt(){const t=y(),{products:n}=p(a=>a.products);return g.exports.useEffect(()=>{t(xe()),t(_())},[t]),n.length===0?e.createElement(ve,null,"No products in db"):e.createElement(ie,null,e.createElement(le,null,e.createElement(h,null,"Shop Tech"),e.createElement(s,{my:"10px"},"Everything you want, everything fresh and new be always updated with latest releases")),e.createElement(Ae,null,n.map(a=>e.createElement(Dt,{key:a._id,name:a.name,price:a.price,thumbnail:a.thumbnail,id:a._id}))))}var kt="/assets/about.74ce83db.svg";function At(){return e.createElement(ie,null,e.createElement(le,null,e.createElement(h,null,"About Us"),e.createElement(s,{my:"10px"},"Wanna know more about us?.. this is the page")),e.createElement(w,{flexDirection:"column",py:"54px",px:["20px","20px","145px"],alignItems:"center"},e.createElement(C,{width:["50%","50%","30%"],src:kt,alt:"about",mb:"40px"}),e.createElement(s,{fontSize:"20px"},"As a company, our goal is to improve people's lives, to contribute to the development of our communities and the preservation of the environment. Nowadays, all businesses are generating torrents of data every day about their internal and external customers, and with the right tools and technologies, Edrans can help you get the most out of that information: from insights on consumer behavior, KPIs and environment metrics you can get a deeper level of understanding of your customers\u2019 sentiment and emotional drivers when engaging with your business, and forecasts based on historical data and modelled projections. We humanize data by understanding human behavior, focusing on the functional and emotional aspects of data to create experiences through technology that empower your business and create lasting value.")))}var vt="/assets/contact.7e96ee01.svg";function jt(){return e.createElement(ie,null,e.createElement(le,null,e.createElement(h,null,"Contact Us"),e.createElement(s,{my:"10px"},"We are here to help!")),e.createElement(w,{flexDirection:["column","column","row"],py:"54px",px:["20px","20px","145px"],alignItems:"center",justifyContent:"center"},e.createElement(C,{width:["70%","70%","40%"],src:vt,alt:"about",mb:"40px"}),e.createElement(u,{flexDirection:"column"},e.createElement(h,{mb:"20px"},"Get In Touch"),e.createElement(s,null,"Whatsapp: +5491128576884"),e.createElement(s,null,"Email: joxpulp@gmail.com"))))}var Mt="/assets/404.20cf8557.svg";const N=D(S.button)`
	${P}
	${k}
	${M}
	${A}
...
`;function Ht(o){var c=o,{onCancel:t,currentValue:n,width:a}=c,r=T(c,["onCancel","currentValue","width"]);const[d,m]=me(r),[E,B]=g.exports.useState(!1),{successMsg:I}=p(be=>be.ui),ee=()=>{B(!E),t()};return g.exports.useEffect(()=>{B(!1)},[I]),e.createElement(u,{flexDirection:"column",m:"5px"},e.createElement(u,{mb:"5px"},E?e.createElement(Oe,i(i({width:a||"80%"},d),r)):e.createElement(u,{p:"10px",cursor:"pointer",onClick:ee,alignItems:"center",justifyContent:"center",width:a||"230px",borderBottom:"1px solid #C2C5E1"},e.createElement(s,{fontSize:"13px",color:"#9b9b9b"},n)),e.createElement(N,{ml:"10px",width:"30px",onClick:ee,type:"button"},E?"Cancel":"Edit")),m.touched&&m.error&&e.createElement(s,{color:"red"},m.error))}const Kt=()=>{const{id:t}=Fe(),n=R(),a=y(),{product:r}=p(o=>o.products);return g.exports.useEffect(()=>{a(H(t))},[a,t]),e.createElement(O,{alignItems:"center",justifyContent:"center",width:"100%",py:"50px",flexDirection:"column"},e.createElement(w,{bg:"white",width:["90%","90%","70%"],height:"900px",alignItems:"center",boxShadow:"0px 0px 25px 10px #F6F4FD",p:"20px",initial:{opacity:0,x:"-90%"},animate:{opacity:1,x:0},exit:{opacity:0,x:"-90%"}},e.createElement(ne,{initialValues:{name:"",description:"",category:"",price:"",thumbnail:null},validationSchema:Tt,onSubmit:o=>{const c=new FormData;o.name!==""&&c.append("name",o.name),o.description!==""&&c.append("description",o.description),o.category!==""&&c.append("category",o.category),o.price!==""&&c.append("price",o.price),o.thumbnail&&c.append("thumbnail",o.thumbnail),a(ce({id:t,formData:c})),o.thumbnail=null}},({values:o,setFieldValue:c})=>e.createElement(re,{style:{width:"100%",display:"flex",flexDirection:"column",alignItems:"center"}},e.createElement(h,{my:"10px"},"Edit Product"),e.createElement(s,{color:"#A9ABBD"},"Click on the image to upload a new thumbnail"),r.map(d=>e.createElement(e.Fragment,null,e.createElement(Me,{currentImage:d.thumbnail,label:"thumbnail",file:o.thumbnail,onCancel:()=>c("thumbnail",null)}),e.createElement("input",{id:"thumbnail",type:"file",onChange:m=>c("thumbnail",m.target.files[0]),hidden:!0}),e.createElement(De,{name:"thumbnail"},m=>e.createElement(s,{color:"red"},m)),e.createElement(L,{currentValue:d.name,id:"name",name:"name",type:"text",placeholder:"Name",onCancel:()=>c("name","")}),e.createElement(Ht,{currentValue:d.description,id:"description",name:"description",type:"text",placeholder:"Description",onCancel:()=>c("description","")}),e.createElement(L,{currentValue:d.category,id:"category",name:"category",type:"text",placeholder:"category",onCancel:()=>c("category","")}),e.createElement(L,{currentValue:d.price,id:"price",name:"price",type:"number",placeholder:"Price",onCancel:()=>c("price","")}))),e.createElement(X,null,"Save")))),e.createElement(s,{m:"30px",cursor:"pointer",onClick:()=>n.go(-1)},"Go Back"))};function Qt(a){var r=a,{label:t}=r,n=T(r,["label"]);const[o,c]=me(n);return e.createElement(u,{m:"20px",flexDirection:"column",width:"100%",alignItems:"center"},e.createElement(Oe,i(i({width:["60%","60%","30%"]},o),n)),c.touched&&c.error&&e.createElement(s,{mt:"3px",color:"red"},c.error))}var Xt="/assets/uploadphoto.e961d561.svg";const Zt=()=>{const t=R(),n=y(),{loading:a}=p(r=>r.ui);return e.createElement(O,{alignItems:"center",justifyContent:"center",width:"100%",py:"50px",flexDirection:"column"},e.createElement(w,{bg:"white",width:["90%","90%","70%"],height:"900px",alignItems:"center",boxShadow:"0px 0px 25px 10px #F6F4FD",p:"20px",initial:{opacity:0,x:"-90%"},animate:{opacity:1,x:0},exit:{opacity:0,x:"-90%"}},e.createElement(ne,{initialValues:{name:"",description:"",category:"",price:"",thumbnail:null},validationSchema:Lt,onSubmit:(r,{resetForm:o})=>{const c=new FormData;r.name!==""&&c.append("name",r.name),r.description!==""&&c.append("description",r.description),r.category!==""&&c.append("category",r.category),r.price!==""&&c.append("price",r.price),r.thumbnail&&c.append("thumbnail",r.thumbnail),n(Se(c)),o()}},({values:r,setFieldValue:o})=>e.createElement(re,{style:{width:"100%",display:"flex",flexDirection:"column",alignItems:"center"}},e.createElement(h,{my:"10px"},"Add a new product"),e.createElement(s,{color:"#A9ABBD"},"Click on the image to upload a new thumbnail"),e.createElement(Me,{currentImage:Xt,label:"thumbnail",file:r.thumbnail,onCancel:()=>o("thumbnail",null)}),e.createElement("input",{id:"thumbnail",name:"thumbnail",type:"file",onChange:c=>o("thumbnail",c.target.files[0]),hidden:!0}),e.createElement(De,{name:"thumbnail"},c=>e.createElement(s,{color:"red"},c)),e.createElement($,{id:"name",name:"name",type:"text",placeholder:"Name*",disabled:a}),e.createElement(Qt,{id:"description",name:"description",type:"text",placeholder:"Description*",disabled:a}),e.createElement($,{id:"category",name:"category",type:"text",placeholder:"Category*",disabled:a}),e.createElement($,{id:"price",name:"price",type:"number",placeholder:"Price*",disabled:a}),e.createElement(X,null,"Add Product")))),e.createElement(s,{m:"30px",cursor:"pointer",onClick:()=>t.go(-1)},"Go Back"))};function ea({error:t,children:n}){return e.createElement(u,{initial:{opacity:0,x:-100},animate:{opacity:1,x:0},exit:{opacity:0,x:-100},position:"fixed",top:"5",left:"2",p:"20px",bg:t?"#FFC7C6":"#C2FFCE",zIndex:100},e.createElement(s,{color:t?"#98210A":"#235234"},n))}function ta(){const t=g.exports.useRef(null),n=y(),{userData:a,loggedIn:r}=p(d=>d.auth),{successMsg:o}=p(d=>d.ui),c=Xe();return g.exports.useEffect(()=>{n(he())},[n]),g.exports.useEffect(()=>{setTimeout(()=>{n(Pe())},2e3)},[n,o]),e.createElement(e.Fragment,null,e.createElement(bt,null),e.createElement(It,null),e.createElement(Ze,{ref:t,timeout:1e3*120,onIdle:()=>n(U()),crossTab:{emitOnAllTabs:!0}}),e.createElement(de,{exitBeforeEnter:!0},o&&e.createElement(ea,null,o)),e.createElement(u,{pt:"60px",width:"100%"},e.createElement(de,{exitBeforeEnter:!0},e.createElement(et,{location:c,key:c.pathname},e.createElement(G,{exact:!0,path:"/",component:Pt}),e.createElement(G,{path:"/product/:id",component:Bt}),e.createElement(G,{path:"/about",component:At}),e.createElement(G,{path:"/contact",component:jt}),e.createElement(Ue,{isAuth:r,path:"/login",component:zt}),e.createElement(Ue,{isAuth:r,path:"/signup",component:Ut}),e.createElement(Z,{isAuth:r,path:"/profile",component:Ot}),e.createElement(Z,{isAuth:r,path:"/cart",component:_t}),e.createElement(Z,{isAuth:r,path:"/purchases",component:Yt}),e.createElement(Z,{exact:!0,isAuth:a.isAdmin,path:"/adminpanel",component:Wt}),e.createElement(Z,{isAuth:a.isAdmin,path:"/adminpanel/add",component:Zt}),e.createElement(Z,{isAuth:a.isAdmin,path:"/adminpanel/productedit/:id",component:Kt}),e.createElement(G,{path:"*",component:Rt})))))}const aa={colors:{primary:"#0D0D0D",secondary:"#979797",subtext:"#b8b8b8"},fonts:{chakra:"'Chakra Petch', sans-serif",lato:"'Lato', sans-serif"}};function na({children:t}){return e.createElement(tt,{theme:aa},t)}const ra=at({reducer:{auth:st,products:ht,cart:mt,purchase:ft,ui:Et},devTools:!1});nt.render(e.createElement(e.StrictMode,null,e.createElement(rt,{store:ra},e.createElement(na,null,e.createElement(ot,null,e.createElement(ta,null))))),document.getElementById("root"));
