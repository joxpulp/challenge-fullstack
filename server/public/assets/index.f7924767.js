...
`;var gt="/assets/cart.7e54eda4.svg";const xt=()=>{const t=E(),{userData:r}=p(n=>n.auth),a=()=>{t(_()),t(fe(!1)),t(xe())},o=()=>{t(fe(!1))};return e.createElement(u,{position:"absolute",width:"120px",alignItems:"center",right:["10px","10px","110px"],top:"5",justifyContent:"center",bg:"#1d1d1dfd",color:"#e4e4e4",height:"160px",zIndex:100},e.createElement(Ie,{display:"flex",flexDirection:"column",alignItems:"center"},e.createElement(B,{to:"/profile",onClick:o},e.createElement(q,{mb:"20px"},"Edit User")),e.createElement(B,{to:"/purchases",onClick:o},e.createElement(q,{mb:"20px"},"Purchases")),r.isAdmin&&e.createElement(B,{to:"/adminpanel",onClick:o},e.createElement(q,{mb:"20px"},"Admin Panel")),e.createElement(q,{onClick:a},"Logout")))};function ft(){const{colors:{primary:t}}=y.exports.useContext(Je),r=E(),{userData:a,logged:o}=p(s=>s.auth),{cartData:n}=p(s=>s.cart),{userMenu:i}=p(s=>s.ui);y.exports.useEffect(()=>{localStorage.setItem("userData",JSON.stringify(a))},[a]),y.exports.useEffect(()=>{localStorage.setItem("cartData",JSON.stringify(n))},[n]);const d=()=>{r(fe(!1))};return e.createElement(u,{position:"relative",as:"header",height:"60px",alignItems:"center",px:["20px","20px","145px"],bg:t,color:"white",borderBottom:"1px solid white"},e.createElement(B,{to:"/",onClick:d},e.createElement(g,{mr:"20px",cursor:"pointer"},"Heki")),e.createElement(u,{as:"nav",flex:1},e.createElement(Ie,{flex:1,justifyContent:"space-evenly"},e.createElement(B,{to:"/",onClick:d},e.createElement(q,null,"Shop")),e.createElement(B,{to:"/about",onClick:d},e.createElement(q,null,"About")),e.createElement(B,{to:"/contact",onClick:d},e.createElement(q,null,"Contact"))),e.createElement(Ie,{justifyContent:"space-evenly"},e.createElement(B,{to:"/cart"},e.createElement(u,{alignItems:"center",mr:"20px",onClick:d},e.createElement(w,{mr:"5px",src:gt}),e.createElement(m,null,o&&n.length!==0&&n.totalItems))),e.createElement(u,{height:"100%",alignItems:"center"},o?e.createElement(u,{onClick:()=>r(fe(!i))},e.createElement(w,{borderRadius:"100%",width:"20px",mr:"10px",src:a.avatar}),e.createElement(q,null,a.name)):e.createElement(B,{to:"/login"},e.createElement(q,null,"Login")))),i&&e.createElement(xt,null)))}const U=D(I.main)`
	${S}
	${M}
	${j}
	${P}
